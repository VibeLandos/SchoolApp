...
| `ThemeSettings.kt` | стиль (You / стекло), яркость, seed-цвет, язык, звонки, длина учебной недели (5/6), даты учебного года |
| `SchoolYear.kt` | начало и конец учебного года (по умолчанию 1 сент. — 25 мая) |
...
| `components/AppSurfaces.kt` | Шапка экрана, карточка, бейдж номера, кружки цветов, кольцо прогресса |
...
| `now/NowScreen.kt` | Вкладка «Сейчас»: большой круг до звонка, кольцо на каждом уроке, внизу до конца учебного года |
...
| `components/SchoolYearSheet.kt` | даты начала и конца учебного года |
