...
Нижние вкладки: **Дневник** (`diary`), **Сейчас** (`now`), **Задания** (`tasks`). Меню: иконка «гамбургер» на всех экранах. Язык: русский по умолчанию, английский из меню. Учебная неделя: 5 или 6 дней. Звонки: быстрая настройка на неделю, день можно задать отдельно.
